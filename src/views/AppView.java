	...
	public void grupos() {
	    ...
	    class PanelBotones extends JPanel implements TableCellRenderer {
	        public PanelBotones() {
	            ...
	            JButton btnVer = new JButton();
	            btnVer.setIcon(new ImageIcon(new ImageIcon(
	                AppView.class.getResource("/resources/eye.png"))
	            ...
	            JButton btnEditar = new JButton();
	            btnEditar.setIcon(new ImageIcon(new ImageIcon(
	                AppView.class.getResource("/resources/square-pen.png"))
	                .getImage().getScaledInstance(25, 25, Image.SCALE_SMOOTH)));
	            btnEditar.setPreferredSize(new Dimension(25, 25));
	            btnEditar.setBorderPainted(false);
	            btnEditar.setContentAreaFilled(false);
	            ...
	            btnEliminar.setIcon(new ImageIcon(new ImageIcon(
	                AppView.class.getResource("/resources/trash.png"))
	                .getImage().getScaledInstance(25, 25, Image.SCALE_SMOOTH)));
	            btnEliminar.setPreferredSize(new Dimension(25, 25));
	            btnEliminar.setBorderPainted(false);
	            btnEliminar.setContentAreaFilled(false);
	...
	public void asignaturas() {
	    ...
	    class PanelBotones extends JPanel implements TableCellRenderer {
	        ...
	        public PanelBotones() {
	            ...
	            JButton btnVer = new JButton("");
	            btnVer.setIcon(new ImageIcon(new ImageIcon(AppView.class.getResource("/resources/eye.png")).getImage().getScaledInstance(25, 25, Image.SCALE_SMOOTH)));
	            btnVer.setPreferredSize(new Dimension(25, 25));
	            btnVer.setBorderPainted(false);
	            btnVer.setContentAreaFilled(false);
	            btnVer.setFocusPainted(false);
	            ...
	            JButton btnEditar = new JButton("");
	            btnEditar.setIcon(new ImageIcon(new ImageIcon(AppView.class.getResource("/resources/square-pen.png")).getImage().getScaledInstance(25, 25, Image.SCALE_SMOOTH)));
	            btnEditar.setPreferredSize(new Dimension(25, 25));
	            btnEditar.setBorderPainted(false);
	            btnEditar.setContentAreaFilled(false);
	            btnEditar.setFocusPainted(false);
	            ...
	            JButton btnEliminar = new JButton("");
	            btnEliminar.setIcon(new ImageIcon(new ImageIcon(AppView.class.getResource("/resources/trash.png")).getImage().getScaledInstance(25, 25, Image.SCALE_SMOOTH)));
	            btnEliminar.setPreferredSize(new Dimension(25, 25));
	            btnEliminar.setBorderPainted(false);
	            btnEliminar.setContentAreaFilled(false);
	            btnEliminar.setFocusPainted(false);
